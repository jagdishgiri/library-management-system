...
import random
import sqlite3
image1='./images/library.png'
image2='./images/image2.png'
image3='./images/home.jpg'
#pip install Pillow
class menu:
    ...
    def __init__(self):
        ...
        conn=sqlite3.connect('book_detail.db')
    ...
    def addbook(self):
        ...
        l1=Label(self.f1,text='Book ID : ',font='Papyrus 12 bold',fg='red',bg='Black',pady=1).place(x=50,y=50)
...
def Database():
    ...
    if cursor.fetchone() is None:
        cursor.execute("INSERT INTO `login` (username, password) VALUES('jagdish', 'root')")
        conn.commit()
...
#==============================LABELS=========================================
lbl_title = Label(canvas, text = "ADMIN   LOGIN", font=('arial', 40,'bold', ),bg='black', fg='white')
lbl_title.place(x=500,y=100)
lbl_username = Label(canvas, text = "Username:", font=('airal', 30,'bold'),bd=4,bg='black', fg='white')
lbl_username.place(x=500,y=230)
lbl_password = Label(canvas, text = "Password :", font=('airal', 30,'bold'),bd=4, bg='black', fg='white')
...
#==============================ENTRY WIDGETS==================================
username = Entry(canvas, textvariable=USERNAME, font=(30), bg='black', fg='white',bd=13)
username.place(x=750, y=230,)
password = Entry(canvas, textvariable=PASSWORD, show="*", font=(30),bg='black', fg='white',bd=13)
password.place(x=750, y=330)
